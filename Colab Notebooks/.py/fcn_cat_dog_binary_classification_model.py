# -*- coding: utf-8 -*-
"""FCN Cat-Dog Binary Classification Model.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1riBAhU5yqDL_juqOCjs9AXfgn4whi6w5
"""
...
# as values are in range from 0 to 255 but to train our model appropriately we need to rescale these values between 0 to 1
...
# graph showing curve of loss and accuracy in our model
